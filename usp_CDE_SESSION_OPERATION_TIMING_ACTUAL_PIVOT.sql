...
/****** Object:  StoredProcedure [dbo].[usp_CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT]    Script Date: 06/01/2019 23:27:20 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[usp_CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT]
...
BEGIN
	...
	IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT]') AND type in (N'U'))
	DROP TABLE CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT
	...
	INTO CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT
	...
	Update dbo.CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT
	...
	FROM    dbo.CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT
