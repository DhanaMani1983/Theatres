...
/****** Object:  StoredProcedure [dbo].[usp_Populate_Surginet_Theatre_Utilization_Report_Dashboard]    Script Date: 06/01/2019 23:42:10 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[usp_Populate_Surginet_Theatre_Utilization_Report_Dashboard]
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Theatre_Utilization_Report_Dashboard]') AND type in (N'U'))
DROP TABLE [Theatre_Utilization_Report_Dashboard]

    
select q.* INTO [Theatre_Utilization_Report_Dashboard]  from     
(select 
...
o.CANCELLED_DT_TM,
CAST(NULL as 	varchar(8000)	)	as		Case_Site,
CAST(NULL as 	date	)	as		Case_Operation_Date,
CAST(NULL as 	varchar(50)	)	as		Case_Session_ID,
CAST(NULL as 	varchar(50)	)	as		Case_SESSION_BEG_DT_TM,
CAST(NULL as 	varchar(50)	)	as		Case_SESSION_END_DT_TM,
CAST(NULL as 	varchar(50)	)	as		Case_MRN,
CAST(NULL as 	varchar(50)	)	as		Case_PatientSurname,
CAST(NULL as 	varchar(50)	)	as		Case_PatientForename,
CAST(NULL as 	datetime	)	as		Case_DateOfBirth,
CAST(NULL as 	varchar(100)	)	as		Case_Patient_Age_Text,
CAST(NULL as 	varchar(50)	)	as		Case_Patient_Age_Years,
CAST(NULL as 	varchar(50)	)	as		Case_NHSNumber,
CAST(NULL as 	varchar(100)	)	as		[Case_Case Number Formatted],
CAST(NULL as 	varchar(500)	)	as		[Case_CONSULTANT SURGEON],
CAST(NULL as 	varchar(25)	)	as		Case_Consultant_Surgeon_GMC_Code,
CAST(NULL as 	varchar(500)	)	as		[Case_Surgical Case Specialty],
CAST(NULL as 	varchar(50)	)	as		[Case_Patient Type],
CAST(NULL as 	varchar(500)	)	as		[Case_Case Type],
CAST(NULL as 	varchar(100)	)	as		[Case_ASA_CLASS],
CAST(NULL as 	varchar(255)	)	as		[Case_Theatre Number],
CAST(NULL as 	datetime	)	as		[Case_Patient Sent For],
CAST(NULL as 	datetime	)	as		[Case_Patient Arrived],
CAST(NULL as 	datetime	)	as		[Case_Anaes Start],
CAST(NULL as 	datetime	)	as		[Case_Anaes Stop],
CAST(NULL as 	datetime	)	as		[Case_Patient In Room],
CAST(NULL as 	datetime	)	as		[Case_Surgery Start],
CAST(NULL as 	datetime	)	as		[Case_Surgery Stop],
CAST(NULL as 	datetime	)	as		[Case_Patient Out Room],
CAST(NULL as 	datetime	)	as		[Case_Patient In Recovery],
CAST(NULL as 	datetime	)	as		[Case_Patient Out Recovery],
CAST(NULL as 	varchar(100)	)	as		[Case_Anaesthesia Type],
CAST(NULL as 	varchar(100)	)	as		[Case_Primary Procedure],
CAST(NULL as 	varchar(255)	)	as		[Case_PRIMARY_PROCEDURE_FREE_TXT],
CAST(NULL as 	varchar(255)	)	as		[Case_LATERALITY],
CAST(NULL as 	varchar(19)	)	as		[Case_Secondary Procedure],
CAST(NULL as 	varchar(200)	)	as		Case_Operating_Surgeon,
CAST(NULL as 	varchar(25)	)	as		Case_Operation_Surgeon_GMC_Code,
CAST(NULL as 	varchar(200)	)	as		Case_Anaesthetist_Main,
CAST(NULL as 	varchar(25)	)	as		Case_Anaesthetist_Main_GMC_Code,
CAST(NULL as 	varchar(200)	)	as		Case_Anaesthetist_Other,
CAST(NULL as 	varchar(25)	)	as		Case_Anaesthetist_Other_GMC_Code,
CAST(NULL as 	varchar(200)	)	as		Case_First_Assistant,
CAST(NULL as 	varchar(25)	)	as		Case_First_Assistant_GMC_Code,
CAST(NULL as 	varchar(200)	)	as		Case_Second_Assistant,
CAST(NULL as 	varchar(25)	)	as		Case_Second_Assistant_GMC_Code,
CAST(NULL as 	varchar(200)	)	as		Case_Scrub_Practitioner,
CAST(NULL as 	varchar(200)	)	as		Case_ODP,
CAST(NULL as 	varchar(200)	)	as		Case_Radiographer,
CAST(NULL as 	varchar(200)	)	as		Case_Circulator_1,
CAST(NULL as 	varchar(200)	)	as		Case_Circulator_2,
CAST(NULL as 	varchar(200)	)	as		Case_Circulator_3,
CAST(NULL as 	varchar(200)	)	as		Case_PACU_Practitioner,
CAST(NULL as 	varchar(200)	)	as		Case_Anaesthetic_Practitioner,
CAST(NULL as 	varchar(200)	)	as		Case_Scrub_2,
CAST(NULL as 	varchar(200)	)	as		Case_HCA,
CAST(NULL as 	varchar(200)	)	as		Case_Theatre_Support_Worker,
CAST(NULL as 	varchar(200)	)	as		Case_Perfusionist,
CAST(NULL as 	varchar(20)	)	as		Case_Patient_Gender,
CAST(NULL as 	varchar(10)	)	as		Case_Temp_On_Arrival,
CAST(NULL as 	varchar(25)	)	as		Case_PONV,
CAST(NULL as 	varchar(25)	)	as		Case_Pain_Score_On_Arrival,
CAST(NULL as 	varchar(100)	)	as		Case_SURGICAL_CASE_ID,
CAST(NULL as 	varchar(40)	)	as		Case_SCH_APPT_ID,
CAST(NULL as 	varchar(40)	)	as		Case_ENCNTR_ID,
CAST(NULL as 	datetime	)	as		Case_CANCELLED_DT_TM,
CAST(NULL as 	varchar(500)	)	as		[Case_Operation Cancellation Reason Code],
CAST(NULL as 	varchar(500)	)	as		[Case_Operation Cancellation Reason Desc],
CAST(NULL as 	varchar(255)	)	as		Case_Planned_Procedure_Type,
CAST(NULL as 	varchar(100)	)	as		Case_Clinical_Non_Clinical_Cancellation_Only
...
And ( exists (Select 1 From UKRWH_CDE_SURGICAL_CASE sc where sc.SCH_APPT_ID = o.SCH_APPT_ID) And (s.SCHED_STATUS_CD<>'9543' or o.CANCELLED_DT_TM is not null))
...
Update Theatre_Utilization_Report_Dashboard
...
End)
from UKRWH_CDE_SCH_APPT_SLOTS s inner join OPERATION_DUMP o on s.SCH_APPT_ID= o.SCH_APPT_ID Inner join NON_CDE_EDW_F_Session_WITH_SEQUENCE ns on ns.SESSION_SK= s.BLOCK_INSTANCE_ID
inner join Theatre_Utilization_Report_Dashboard t on t.BLOCK_INSTANCE_ID= o.BLOCK_INSTANCE_ID
...
Update dbo.Theatre_Utilization_Report_Dashboard
...
From Theatre_Utilization_Report_Dashboard t inner join CDE_SESSION_OPERATION_TIMING_ACTUAL_PIVOT sp on t.BLOCK_INSTANCE_ID=sp.BLOCK_INSTANCE_ID
...
From Theatre_Utilization_Report_Dashboard t inner join CDE_SESSION_OPERATION_TIMING_ACTUAL_WITHIN_PLANNED_PIVOT sp on t.BLOCK_INSTANCE_ID=sp.BLOCK_INSTANCE_ID
...
From Theatre_Utilization_Report_Dashboard t inner join 
...
ALTER TABLE Theatre_Utilization_Report_Dashboard
...
From Theatre_Utilization_Report_Dashboard
...
FROM dbo.Theatre_Utilization_Report_Dashboard WITH (nolock) LEFT OUTER JOIN
[Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction] WITH (nolock) ON dbo.Theatre_Utilization_Report_Dashboard.[Session Treatment Function Local] = [Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction].TreatmentFunctionLocalCode
WHERE dbo.Theatre_Utilization_Report_Dashboard.DivisionCode IS NULL OR dbo.Theatre_Utilization_Report_Dashboard.DivisionCode = ''
...
SET DivisionCode = [Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction].DivisionCode,
	...
	[Session Division ID]= [Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction].DivisionCode
FROM dbo.Theatre_Utilization_Report_Dashboard WITH (nolock) LEFT OUTER JOIN
[Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction] WITH (nolock) ON dbo.Theatre_Utilization_Report_Dashboard.TREATMENT_FUNCTION_CODE_NATIONAL = [Cerner_ReferenceData].[dbo].[Dim_TreatmentFunction].TreatmentFunctionCode
...
From Theatre_Utilization_Report_Dashboard T Inner Join ( Select * from 	Theatre_Utilization_Report_Dashboard T1 Where DivisionCode is not null) q
...
From Theatre_Utilization_Report_Dashboard T inner Join DIM_Theatre_Consultants c on t.Consultant= c.[Slot Consultant] And t.[Session Specialty]= c.[Slot Specialty] 

UPDATE Theatre_Utilization_Report_Dashboard
SET Consultant_Name=Consultant
From Theatre_Utilization_Report_Dashboard T
...
From Theatre_Utilization_Report_Dashboard T inner Join DIM_Theatre_DIV_Specialty c on  t.[Session Specialty]= c.[Slot Specialty] 
...
From Theatre_Utilization_Report_Dashboard where Consultant_Name = 'cancelled'
...
from UKRWH_CDE_SCH_APPT_REMOVED_THEATRE_SLOTS s Inner join Theatre_Utilization_Report_Dashboard t on s.SCH_APPT_ID= t.SCH_APPT_ID
...
From Theatre_Utilization_Report_Dashboard t inner join (Select THEATRE_NBR_CD,SURGICAL_CASE_ID,SCH_APPT_ID,ENCNTR_ID From ukrwh_cde_surgical_case) q on t.SURGICAL_CASE_ID= q.SURGICAL_CASE_ID 
...
Delete  from Theatre_Utilization_Report_Dashboard 
...
FROM         dbo.OPERATION_DUMP INNER JOIN
                      ...
                      and Theatre_Utilization_Report_Dashboard.SURGICAL_CASE_NBR_TXT= OPERATION_DUMP.SURGICAL_CASE_NBR_TXT
...
(select a.[Session Specialty Desc],convert(varchar,a.[Session Date],101) as [Session Date],a.[Session Planned Start-End Times],a.[Session Theatre Code],a.BLOCK_INSTANCE_ID
 From Theatre_Utilization_Report_Dashboard a inner join Theatre_Utilization_Report_Dashboard b on
...
From [SESSION] s inner join Theatre_Utilization_Report_Dashboard t on s.SESSION_SK= t.BLOCK_INSTANCE_ID
...
from [Theatre_Utilization_Report_Dashboard] where 
...
UPDATE [dbo].[Theatre_Utilization_Report_Dashboard]
   SET
       [Case_Site] = tbf.Site
      ,[Case_Operation_Date] = tbf.Operation_Date
      ,[Case_Session_ID] = tbf.Session_ID
      ,[Case_SESSION_BEG_DT_TM] = tbf.SESSION_BEG_DT_TM
      ,[Case_SESSION_END_DT_TM] = tbf.SESSION_END_DT_TM
      ,[Case_MRN] = tbf.MRN
      ,[Case_PatientSurname] = tbf.PatientSurname
      ,[Case_PatientForename] = tbf.PatientForename
      ,[Case_DateOfBirth] = tbf.DateOfBirth
      ,[Case_Patient_Age_Text] = tbf.Patient_Age_Text
      ,[Case_Patient_Age_Years] = tbf.Patient_Age_Years
      ,[Case_NHSNumber] = tbf.NHSNumber
      ,[Case_Case Number Formatted] = tbf.[Case Number Formatted]
      ,[Case_CONSULTANT SURGEON] = tbf.[CONSULTANT SURGEON]
      ,[Case_Consultant_Surgeon_GMC_Code] = tbf.Consultant_Surgeon_GMC_Code
      ,[Case_Surgical Case Specialty] = tbf.[Surgical Case Specialty]
      ,[Case_Patient Type] = tbf.[Patient Type]
      ,[Case_Case Type] = tbf.[Case Type]
      ,[Case_ASA_CLASS] = tbf.ASA_CLASS
      ,[Case_Theatre Number] = tbf.[Theatre Number]
      ,[Case_Patient Sent For] = tbf.[Patient Sent For]
      ,[Case_Patient Arrived] = tbf.[Patient Arrived]
      ,[Case_Anaes Start] = tbf.[Anaes Start]
      ,[Case_Anaes Stop] = tbf.[Anaes Stop]
      ,[Case_Patient In Room] = tbf.[Patient In Room]
      ,[Case_Surgery Start] = tbf.[Surgery Start]
      ,[Case_Surgery Stop] = tbf.[Surgery Stop]
      ,[Case_Patient Out Room] = tbf.[Patient Out Room]
      ,[Case_Patient In Recovery] = tbf.[Patient In Recovery]
      ,[Case_Patient Out Recovery] = tbf.[Patient Out Recovery]
      ,[Case_Anaesthesia Type] = tbf.[Anaesthesia Type]
      ,[Case_Primary Procedure] = tbf.[Primary Procedure]
      ,[Case_PRIMARY_PROCEDURE_FREE_TXT] = tbf.PRIMARY_PROCEDURE_FREE_TXT
      ,[Case_LATERALITY] = tbf.LATERALITY
      ,[Case_Secondary Procedure] = tbf.[Secondary Procedure]
      ,[Case_Operating_Surgeon] = tbf.Operating_Surgeon
      ,[Case_Operation_Surgeon_GMC_Code] = tbf.Operation_Surgeon_GMC_Code
      ,[Case_Anaesthetist_Main] = tbf.Anaesthetist_Main
      ,[Case_Anaesthetist_Main_GMC_Code] = tbf.Anaesthetist_Main_GMC_Code
      ,[Case_Anaesthetist_Other] = tbf.Anaesthetist_Other
      ,[Case_Anaesthetist_Other_GMC_Code] = tbf.Anaesthetist_Other_GMC_Code
      ,[Case_First_Assistant] = tbf.First_Assistant
      ,[Case_First_Assistant_GMC_Code] = tbf.First_Assistant_GMC_Code
      ,[Case_Second_Assistant] = tbf.Second_Assistant
      ,[Case_Second_Assistant_GMC_Code] = tbf.Second_Assistant_GMC_Code
      ,[Case_Scrub_Practitioner] = tbf.Scrub_Practitioner
      ,[Case_ODP] = tbf.ODP
      ,[Case_Radiographer] = tbf.Radiographer
      ,[Case_Circulator_1] = tbf.Circulator_1
      ,[Case_Circulator_2] = tbf.Circulator_2
      ,[Case_Circulator_3] = tbf.Circulator_3
      ,[Case_PACU_Practitioner] = tbf.PACU_Practitioner
      ,[Case_Anaesthetic_Practitioner] = tbf.Anaesthetic_Practitioner
      ,[Case_Scrub_2] = tbf.Scrub_2
      ,[Case_HCA] = tbf.HCA
      ,[Case_Theatre_Support_Worker] = tbf.Theatre_Support_Worker
      ,[Case_Perfusionist] = tbf.Perfusionist
      ,[Case_Patient_Gender] = tbf.Patient_Gender
      ,[Case_Temp_On_Arrival] = tbf.Temp_On_Arrival
      ,[Case_PONV] = tbf.PONV
      ,[Case_Pain_Score_On_Arrival] = tbf.Pain_Score_On_Arrival
      ,[Case_SURGICAL_CASE_ID] = tbf.SURGICAL_CASE_ID
      ,[Case_SCH_APPT_ID] = tbf.SCH_APPT_ID
      ,[Case_ENCNTR_ID] = tbf.ENCNTR_ID
      ,[Case_CANCELLED_DT_TM] = tbf.CANCELLED_DT_TM
      ,[Case_Operation Cancellation Reason Code] = tbf.[Operation Cancellation Reason Code]
      ,[Case_Operation Cancellation Reason Desc] = tbf.[Operation Cancellation Reason Desc]
      ,[Case_Planned_Procedure_Type] = tbf.[Case_Planned_Procedure_Type]
      ,[Case_Clinical_Non_Clinical_Cancellation_Only] = tbf.[Case_Clinical_Non_Clinical_Cancellation_Only]
 From [Theatre_Utilization_Report_Dashboard] ts inner Join Theatre_Belvan_Finance_Report tbf on ts.SURGICAL_CASE_ID= tbf.SURGICAL_CASE_ID
